          ...
          <div className="">
            <div className="row">
              ...
              <div className="row">
                ...
                <div className="upcoming py-2 pb-4 text-center px-3">
                  <h3>Upcoming Events</h3>
                  <div className="event px-3 my-2 border0 shadow-sm rounded-3 d-flex align-items-center justify-content-between">
                    <div className="fs-6 fw-bolder ">International Conference on Civil, Architectural and En</div>
              ...
              <div className="col-4">
                <div className="frame p-3">
                 <img src="/mainIcons/addImg.png" width="100%" height="100%" alt="vikara"/>
                </div>
              </div>
            </div>
          </div>
