...
const MapWrapper = (props) => {
    ...
    useEffect(() => {
        ...
        axios
            .get("https://32dd-123-231-61-157.in.ngrok.io/wardname", {
                headers: {
    ...
    const handleChip = (chip) => {
        ...
        setChecked(false);
        axios
            .get("https://32dd-123-231-61-157.in.ngrok.io/locate", {
                headers: {
                    "Access-Control-Allow-Origin": "*",
                    "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
                },
        ...
        // get illegal spots
        axios
            .get("https://32dd-123-231-61-157.in.ngrok.io/ill_locate", {
                headers: {
                    "Access-Control-Allow-Origin": "*",
                    "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
                },
    ...
    const handleSelect = (val) => {
        ...
        axios
            .get("https://32dd-123-231-61-157.in.ngrok.io/loctypes", {
                headers: {
                    "Access-Control-Allow-Origin": "*",
                    "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
                },
